...
export function ThemeToggle({
  ...
  // Sync with global Tailwind dark class and localStorage on mount
  useEffect(() => {
  ...
  const pageStyle: CSSProperties = {
    minHeight: "100vh",
    paddingTop: isIcon ? 0 : barHeight,
    background: isIcon ? "transparent" : t.pageBg,
    color: isIcon ? "inherit" : t.pageText,
  ...
  const curtainStyle: CSSProperties = {
    ...
    zIndex: 99999, // Ensure it's above everything including portals
    pointerEvents: "none",
  };
