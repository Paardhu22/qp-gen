          ...
          {isLoadingQuestions ? (
            ...
            <div className="grid gap-4 md:grid-cols-2">
              {filteredQuestions.map((q) => (
                <Card key={q.id} className="bg-card border-border flex flex-col h-full hover:shadow-md transition-shadow">
                  ...
                  <CardContent className="flex-1">
                    <p className="text-sm text-foreground line-clamp-4">{q.content}</p>
                    {q.answer && (
                      <div className="mt-4 text-[11px] text-muted-foreground bg-muted/50 p-2 rounded-md border border-border/50">
