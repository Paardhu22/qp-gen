"""
In-memory semantic index for concept context.
"""

import math
from typing import List

from ...domain.datatypes import SemanticTextbookChunk
...
class SemanticSearchIndex:
    ...
    def retrieve(self, concept_id: str, query_embedding: List[float], max_chunks: int = 1) -> List[SemanticTextbookChunk]:
        matches = []
