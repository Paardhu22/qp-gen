"""
AOS Science — Stream Foundation Engine
=========================================
Defines the cognitive profiles, diagram coefficients, and theory/practical
ratios for Physics, Chemistry, Biology, and Integrated streams.
"""

from typing import Dict, List

from q_instructions.core.enums import AcademicClass, StreamType, CognitiveStyle
from q_instructions.core.datatypes import StreamProfile, TheoryPracticalRatio


class StreamFoundationEngine:
    """Enforces cognitive styles, diagram frequencies, and math metrics per stream."""
    ...
    def get_recommended_stream(self, academic_class: AcademicClass, topic_hint: str) -> StreamType:
        """Determines stream from class level and text triggers."""
        ...
        triggers: Dict[StreamType, List[str]] = {
            StreamType.PHYSICS: [
                "force", "motion", "speed", "electricity", "circuit", "mirror",
                "lens", "refraction", "light", "watt", "ohm", "ampere", "magnetic"
            ],
            StreamType.CHEMISTRY: [
                "acid", "base", "salt", "reaction", "equation", "element", "metal",
                "non-metal", "carbon", "bond", "atom", "molecule", "solution"
            ],
            StreamType.BIOLOGY: [
                "cell", "tissue", "organ", "plant", "animal", "reproduction",
                "digestive", "respiration", "heredity", "gene", "neuron", "ecosystem"
            ],
        }
