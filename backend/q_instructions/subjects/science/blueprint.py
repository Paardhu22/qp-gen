"""
AOS Science — Exam Blueprint Registry
========================================
Defines standard CBSE exam structures (sections, marks, times).
"""
...
class ExamBlueprintRegistry:
    """Factory containing master structures conforming to CBSE layouts."""
    ...
    def _initialize(self) -> None:
        # Class 10 CBSE Science Board Exam (80 marks, 3 hours)
        sections_c10 = [
        ...
        # Class 10 Unit Test (25 marks, 45 min)
        sections_unit = [
